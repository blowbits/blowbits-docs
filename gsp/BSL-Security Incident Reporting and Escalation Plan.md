...
This document defines the reporting, communication and escalation process for information security incidents affecting the Blowbits Solutions LLP GST Suvidha Provider (GSP) platform.
...
Upon identification of a suspected or confirmed information security incident, the following activities shall be performed:

1. Detect and record the incident.
2. Notify the Technical & Security SPOC.
3. Perform an initial assessment.
4. Initiate containment activities.
5. Escalate the incident to Management.
6. Determine whether external reporting is required.
7. Notify GSTN and other authorised authorities, where applicable.
8. Complete investigation and recovery.
...
Where applicable, incident reports should include:
