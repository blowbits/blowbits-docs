...
Network security controls are implemented to regulate communication between internal systems and external entities.
...
- Restrict network access to authorised services and endpoints.
...
- Access to network services is restricted according to operational requirements.
- Network boundaries are protected through appropriate security controls.
...
- Management of communication pathways.
