...
This Standard Operating Procedure (SOP) defines the process for provisioning, modifying, protecting and revoking user accounts and authentication credentials within the Blowbits Solutions LLP GST Suvidha Provider (GSP) platform.
...
- Secure storage of system credentials.
...
- Access permissions may be modified.
