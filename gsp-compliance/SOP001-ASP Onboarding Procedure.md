...
This Standard Operating Procedure (SOP) defines the process for onboarding Application Service Providers (ASPs) to the Blowbits Solutions LLP GST Suvidha Provider (GSP) platform.
...
Required information includes, as applicable:
...
- ASP GSTIN validation.
- Successful completion of technical integration testing.
- Authentication and security control implementation.
- Valid ISO/IEC 27001 certification (or applicable version notified by GSTN), where required.
- Valid annual Vulnerability Assessment and Penetration Testing (VAPT) report issued by a CERT-In empanelled auditor, where required.
- Compliance with applicable GSTN GSP operational and security requirements.
...
Following onboarding, ASP access shall be governed throughout its operational lifecycle.
